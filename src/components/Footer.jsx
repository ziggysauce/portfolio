			...
			<footer className="footer">
				...
				<div className="footer-right">
					...
					<ul className="footer__link-list">
						...
						<li><a className="footer__link" href="https://drive.google.com/file/d/1VdoxUOacJ6HNdt8ZyIqjZT9s1QxdWzi1/view?usp=sharing" target="_blank"><i className="fas fa-file-pdf"></i></a></li>
					</ul>
				</div>
			</footer>
		);
